...
function main(){
	...
	vidMp4Src = mp4.src;vidWebmSrc = webm.src;
	...
	if(view == false){
		...
		setTimeout(function(){
			$.ajax({
				...
				data 	: {},
				success : function(e){
					console.log('success' + e.totalView);
				},
				error   : function(e){
