...
function highQuality(e){
	...
	if(mediaPlayer.canPlayType("video/mp4")){source.setAttribute('src', '/videos/6-grald/Sl808boQRhH/Sl808boQRhH_hd.mp4');}
    else if(mediaPlayer.canPlayType("video/webm")){source.setAttribute('src', '/videos/6-grald/Sl808boQRhH/Sl808boQRhH_hd.webm');}
    else if(mediaPlayer.canPlayType("video/ogg")){source.setAttribute('src', '/videos/6-grald/Sl808boQRhH/Sl808boQRhH_hd.ogg');}
    else{window.alert("Can't play video source.");}mediaPlayer.pause();mediaPlayer.load();togglePlayPause();	
}
function lowQuality(e){
	e.preventDefault();
	var source = document.getElementById('vid-src');
	if(mediaPlayer.canPlayType("video/mp4")){source.setAttribute('src', '/videos/6-grald/Sl808boQRhH/Sl808boQRhH_low.mp4');}
    else if(mediaPlayer.canPlayType("video/webm")){source.setAttribute('src', '/videos/6-grald/Sl808boQRhH/Sl808boQRhH_low.webm');}
    else if(mediaPlayer.canPlayType("video/ogg")){source.setAttribute('src', '/videos/6-grald/Sl808boQRhH/Sl808boQRhH_low.ogg');}
    else{window.alert("Can't play video source.");}mediaPlayer.pause();mediaPlayer.load();togglePlayPause();
}
...
function checkVid(){
	if(isNaN(durSec)){
		...
		$('.ctime').fadeOut('fast');
		$('#vid-error').html('Error: Please try again later.').css({'color':'#fff'});		
	}
}
