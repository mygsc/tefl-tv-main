...
$('#media-video').bind('ended', function(){if(!this.paused) this.pause();});
...
function seekTimeUpdate(){
	...
	$(currentProgress).css({'width' : updProgWidth + '%'});
	 handle = $(currentProgress).offset().left;
