...
function seekTimeUpdate(){
	...
	$('#current-progress').css({'width' : updProgWidth + '%'});
	 handle = $('#current-progress').offset().left;
	$('#button-progress').css({'left' : handle +  '%'});

	console.log(updProgWidth);
...
function timeoutMouseMove(milliseconds){
	clearTimeout(timeout);
  	timeout = setTimeout(function(){$('#controls').fadeOut(500);}, milliseconds);
}
