				...
				@foreach($video_path as $video)
					<div id="vid-controls">
						<div class="embed-responsive embed-responsive-16by9">
							...
							<video preload="auto" id="media-video" width="100%" poster="/videos/{{$video->user_id}}-{{$owner->channel_name}}/{{$video->file_name}}/{{$video->file_name}}.jpg" class="embed-responsive-item">
								<source id="vid_src" src='/videos/{{$video->user_id}}-{{$owner->channel_name}}/{{$video->file_name}}/{{$video->file_name}}.mp4' type='video/mp4'>
