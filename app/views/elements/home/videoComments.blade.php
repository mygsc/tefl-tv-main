	...
	<div class="grey same-H pad-v-10">
		<div class="row">
			<div class="content-padding">       
				<h3 class="orangeC">Write a comment</h3>
					...
					<div class="commentsarea row commentDeleteArea">
						...
						<div class="col-md-11">
							<div class="row">
								...
								<span class='tooltipDelete inline'>
									@if(isset(Auth::User()->id))
								...
								$ifAlreadyDisliked = DB::table('comments_likesdislikes')->where(array(
									...
									?>
									<span class="">Reply</span><br/>
									<span class="repLink hand">View {{$getCommentRepliesCount}} replies.</span>
