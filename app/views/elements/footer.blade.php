    ...
    <div class="container">
        ...
        <div class="col-md-7 col-xs-12">
            <span class="ctgryNav-f">
               <!-- {{ link_to_route('home.index', 'Home', null) }}
                {{ link_to_route('home.aboutus', 'About Us', null) }}
                {{ link_to_route('home.advertisement', 'Advertisement', null) }}
                {{ link_to_route('home.privacy', 'Privacy', null) }}
                {{ link_to_route('home.terms', 'Terms and Condition', null) }}
                {{ link_to_route('home.copyright', 'Copy Right', null) }}-->
