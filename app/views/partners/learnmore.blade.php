            ...
            <div class="paper">
                <div class="content-padding">
    				...
    				<div class="row text-justify">
                        ...
                        <p>
                        We like our partners to inform themselves about the many facets of our program. Therefore, we encourage current and prospective partners to read our <a href="{{route('partners.termsandconditions')}}">Terms and conditions</a><!--,<a href="{{route('partners.faqs')}}"> FAQ</a>,--> and <a href="{{route('homes.privacy')}}">Privacy </a> statements. This way, you know what we expect from you and what you can expect from us.
                        </p>
