...
@section('content')
	...
	{{ Form::open()}}
		{{HTML::image('img/user/0.jpg', 'alt', array('data-toggle' => 'modal', 'data-target' => '#display_picture'))}}
		<br>
		...
		<br>
		{{Form::label('interests', 'Interests: ')}}	{{Form::text('interests',$user_channel->interests, array('placeholder' => 'Interests'))}}
		<br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{Form::open(array('route' => 'users.upload.image', 'files' => 'true'))}}
