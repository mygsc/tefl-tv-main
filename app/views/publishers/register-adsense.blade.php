		...
		<div class="mg-t-20">
			<div class="col-md-10 col-md-offset-1 pub-infoDiv mg-t-20 textbox-layout">
				...
				<div class="well" style="height:350px; overflow:auto;">
					<div id="pub-H"></div> 
					<div class="content-padding">         
						<h2 class="tBlue">Publisher Terms and Conditions</h2>
						...
						<hr/>
						<br/><br/>
						<p><input type="checkbox">I hereby agree to the terms and conditions set forth above.</p>
				...
				<div class="text-right mg-b-20">
					...
					<a href="{{route('publishers.success')}}">{{Form::button('Submit Application', array('class' => 'btn btn-primary'))}}</a>
				</div>
			</div>
		</div>
	</div>
