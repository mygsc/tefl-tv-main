@extends('layouts.publisher')
     ...
     @section('title')
         Terms and Conditions | TEFLTV Publisher
     @stop
                ...
                <div class="content-padding">
                    ...
                    <div class="row text-justify">
                        ...
                        <h2 class="orangeC">Publisher Terms and Conditions</h2>
                              ...
                              <h2 class="orangeC">Definitions:</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Enrollment</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Publisher’s Website Requirements</h2>
                              ...
                              <h2 class="orangeC">Publisher Obligations</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Fraud and Deception: </h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Data Reporting (Stats)</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Contact Information</h2>
                              <p class="text-justify"> 
                              ...
                              <h2 class="orangeC">Payment Policy </h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Costs and Taxes</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Payment Disputes</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Proprietary Rights</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Indemnification: </h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Warranty Disclaimer</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Limitation of Liability </h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Applicability</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Public Release</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC"> Modifications:</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Assignment</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Confidentiality </h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Governing Law and Arbitration </h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Ability to Enter into Agreement</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Relationship of Parties</h2>
                              <p class="text-justify">
                              ...
                              <h2 class="orangeC">Termination</h2>
                              <p class="text-justify">
