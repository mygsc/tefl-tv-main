...
<html>
  ...
  <title>TEFL TV</title>
  <link rel="icon" href="maintenance/img/favIconTv.ico" type="image/gif">
    ...
    <div class="jumbotron">
        <div class="row">
         <div class="animated zoomInDown">
          <img src="img/logo.png" style="max-width:350px;">
          </div>
          <h2 class="wow bounceIn" style="color:#fff;"  data-wow-duration="2s" data-wow-delay="1s">We'll be right back after 5 minutes.</h2>
...
<script src="js/maintenance/wow.js"></script>
