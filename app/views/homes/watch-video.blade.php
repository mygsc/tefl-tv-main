...
@section('meta')
        ...
        <meta property="og:video:url" content="{{asset('/')}}videos/{{$videos->user_id}}-{{$owner->channel_name}}/{{$videos->file_name}}/{{$videos->file_name}}.webm">
        ...
        <meta property="og:video:secure_url" content="https://www.tefltv.com/videos/{{$videos->user_id}}-{{$owner->channel_name}}/{{$videos->file_name}}/{{$videos->file_name}}.webm">
