			...
			<div class="col-md-8">
				<div class="tab-content">
                    <div class="tab-pane active text-justify" id="users">
						...
						<h3>User’s obligations and policy rules concerning Service</h3>
						<p>
						...
						<h3>Other users’ intellectual property rights</h3>
						<p>
						...
						<h3>Proof, retention and storage</h3>
						<p>
                    ...
                    <div class="tab-pane text-justify" id="publishers">
                        <div id="users-H"></div>          
          				...
          				<h3>Publisher’s Website Requirements</h3>
