					...
					<div class="">
						<div class="tab-content">
							...
							<div class="tab-pane" id="advertisers">
								<div id="ad-H"></div>
								<h1 class="">Terms and Conditions for Advertisers</h1>
								<h2>Acceptance of Terms</h2>
								<p class="text-justify">The web pages available at www.tefltv.com and all linked pages (“Site”), are owned and operated by Graphic Studio Central Ltd having its headquarter at 9B, Amtel Building, 148 Des Voeux Road Central, Central Hong Kong and are accessed by you, and can only be accessed by you, the Advertiser, through your prior agreement to the Terms of Use described below (the “Terms”).</p>
								<p class="text-justify">Please read these terms carefully before using www.tefltv.com and any of its features. By accessing the Site, viewing any content on the Site or using any services available on the Site Advertiser explicitly agree to be bound by all these Terms, which together with the www.tefltv.com policy, control our relationship with you when you use the www.tefltv.com site. If you disagree with any of the terms, you may not access the site.  Your use of the site constitutes your consent to all of the Terms.</p>
								<p class="text-justify">By entering into this Agreement, Advertiser, on its own behalf and on behalf of any third party for which is places an Ad (each, a “Principal”) and Advertiser’s agents (collectively, “Advertiser”) understands that Company’s sole obligation is to facilitate placement of advertisements (banners, taglines, text links or e-mail creative, collectively, “Ads”) provided by Advertiser on the www.tefltv.com.</p>
								<p class="text-justify">At any time and in Graphic Studio Central Ltd’s sole discretion, Graphic Studio Central Ltd may modify any of the terms and conditions contained in this Agreement by posting a revised or new agreement.  If any modification is unacceptable to Advertiser, Advertiser’s only recourse is to terminate this Agreement.  Advertiser’s continued participation in the Graphic Studio Central Ltd Network following Graphic Studio Central Ltd’s posting of a new or revised agreement will constitute binding acceptance of the modification.  These terms (or any new or modified agreement, if applicable) shall apply whenever Advertiser places Ads on Sites or otherwise utilizes the Services.</p>

								<h2>Description of Service</h2>
								<p class="text-justify">www.tefltv.com is an online community.  It provides an online space for users to access, view, upload, share and comment on their personal videos. Users may also share their video work through the site.  Users may choose to participate in available contests and promotions, and access and/or purchase services www.tefltv.com makes available on the Site (“Services”). Services include, but are not limited to, any service and/or content that www.tefltv.com provides to its users. Services include all videos and content displayed or transmitted on www.tefltv.com or through the Services. Content (“Content”) includes, but is not limited to text, user comments, messages, information, data, graphics, news articles, photographs, images, illustrations, and software.</p>
								...
								<ul class="text-justify">
									...
									<li>"Affiliate" means, as to an entity, any other entity directly or indirectly controlling, controlled by, or under common control with, such entity. </li>
									<li>"Agency" means the advertising agency listed on the applicable IO. </li>
									<li>"CPA Deliverables" means Deliverables sold on a cost per acquisition basis. </li>
									<li>"CPC Deliverables" means Deliverables sold on a cost per click basis. </li>
									<li>"CPL Deliverables" means Deliverables sold on a cost per lead basis. </li>
									<li>"CPM Deliverables" means Deliverables sold on a cost per thousand impression basis. </li>
									<li>"Deliverable" or "Deliverables" means the inventory delivered by Graphic Studio Central Ltd v(e.g., impressions, clicks, or other desired actions). </li>
									<li>"IO" means a mutually agreed insertion order that incorporates these Terms, under which Graphic Studio Central Ltd will deliver Ads on www.tefltv.com for the benefit of Agency or Advertiser. </li>
									<li>"Graphic Studio Central Ltd Properties" are websites specified on an IO that are owned, operated, or controlled by Graphic Studio Central Ltd. </li>
									<li>"Network Properties" means websites specified on an IO that are not owned, operated, or controlled by Graphic Studio Central Ltd, but on which Graphic Studio Central Ltd has a contractual right to serve Ads. </li>
									<li>"Policies" means advertising criteria or specifications made conspicuously available, including content limitations, technical specifications, privacy policies, user experience policies, policies regarding use of tags, cookies and any other technology now known or hereafter developed that is designed to track users' online behavior or activity, policies regarding consistency with Graphic Studio Central Ltd 's public image, community standards regarding obscenity or indecency (taking into consideration the portion(s) of the Site on which the Ads are to appear), other editorial or advertising policies, and Advertising Materials due dates. </li>
									<li>"Representative" means, as to an entity and/or its Affiliate(s), any director, officer, employee, consultant, contractor, agent, and/or attorney. </li>
									<li>"Site" or "Sites" means Graphic Studio Central Ltd Properties and Network Properties. </li>
									<li>"Terms" means these amended Standard Terms and Conditions for Internet Advertising for Media Buys One Year or Less, Version 3.0. </li>
									<li>"Third Party" means an entity or person that is not a party to an IO; for purposes of clarity, Graphic Studio Central Ltd, Agency, Advertiser, and any Affiliates or Representatives of the foregoing are not Third Parties. </li>
									<li>"Third Party Ad Server" means a Third Party that will serve and/or track Ads.</li>
								</ul>
								<h2>INSERTION ORDERS AND INVENTORY AVAILABILITY</h2>
								<p class="text-justify"><b>IO Details. </b>From time to time, Graphic Studio Central Ltd and Agency may execute IOs. As applicable, each IO will specify: (i) the type(s) and amount(s) of Deliverables, (ii) the price(s) for such Deliverables, (iii) the maximum amount of money to be spent pursuant to the IO, (iv) the start and end dates of the campaign, and (v) the identity of and contact information for any Third Party Ad Server. Other items that may be included are, but are not limited to, reporting requirements, any special Ad delivery scheduling and/or Ad placement requirements, and specifications concerning ownership of data collected. Excluding Advertising Materials provided by Advertiser, Graphic Studio Central Ltd shall own and retain all right, title and interest in any materials and content it creates for the media buy pursuant to the IO. Advertiser agrees that it shall not at any time assert or claim any interest in, or do anything that may adversely affect the validity or enforceability of, any intellectual property or other proprietary right belonging to Graphic Studio Central Ltd hereunder.</p>
								<p class="text-justify"><b>Availability; Acceptance.</b> Graphic Studio Central Ltd will make commercially reasonable efforts to notify Agency within two (2) business days of receipt of an IO signed by Agency if the specified inventory is not available. Acceptance of the IO and these Terms will be deemed the earlier of (i) written (which, unless otherwise specified, for purposes of these Terms, will include paper, fax, or e-mail communication) approval of the IO by Graphic Studio Central Ltd and Agency, or (ii) the display of the first Ad impression by Graphic Studio Central Ltd, unless otherwise agreed on the IO. Notwithstanding the foregoing, modifications to the originally submitted IO will not be binding unless approved in writing by both Graphic Studio Central Ltd and Agency.</p>
								<p class="text-justify">Revisions to accepted IOs will be made in writing and acknowledged by the other party in writing.</p>

								<h2> AD PLACEMENT AND POSITIONING</h2>
								<p class="text-justify"><b>Compliance with IO. </b> Graphic Studio Central Ltd will comply with the IO, including all Ad placement restrictions and will use commercially reasonable efforts to create a reasonably balanced delivery schedule; provided that, Advertiser and Agency acknowledge that given the nature of Graphic Studio Central Ltd's business impressions on Sites may vary at times. Graphic Studio Central Ltd will provide, within the scope of the IO, an Ad to the Site specified on the IO when such Site is visited by an Internet user. Any exceptions will be approved by Agency in writing.</p>
								<p class="text-justify"><b>Changes to Site.</b> Graphic Studio Central Ltd will use commercially reasonable efforts to provide Agency at least 10 business days prior notification of any material changes to the Site that would materially change the target audience or materially affect the size or placement of the Ad specified on the applicable IO. Should such a modification occur with or without notice, as Agency's and Advertiser's sole remedy for such change, Agency may cancel the remainder of the affected placement without penalty within the 10-day notice period. If Graphic Studio Central Ltd has failed to provide such notification, Agency may cancel the remainder of the affected placement within 30 days of such modification and, in such case, will not be charged for any affected Ads delivered after such modification.</p>
								<p class="text-justify"><b>Technical Specifications.</b> Graphic Studio Central Ltd will submit or otherwise make electronically accessible to Agency final technical specifications within two (2) business days of the acceptance of an IO. Changes by Graphic Studio Central Ltd to the specifications of already-purchased Ads after that two (2) business day period will allow Advertiser to suspend delivery of the affected Ad for a reasonable time (without impacting the end date, unless otherwise agreed by the parties) in order to (i) send revised Advertising Materials; (ii) request that Graphic Studio Central Ltd resize the Ad at Graphic Studio Central Ltd's cost, and with final creative approval of Agency, within a reasonable time period to fulfill the guaranteed levels of the IO; (iii) accept a comparable replacement; or (iv) if the parties are unable to negotiate an alternate or comparable replacement in good faith within five (5) business days, immediately cancel the remainder of the affected placement without penalty.</p>

								<h2>PAYMENT AND PAYMENT LIABILITY</h2>
								<p class="text-justify"><b>Invoices.</b> The initial invoice will be sent by Graphic Studio Central Ltd upon completion of the first month's delivery, or within 30 days of completion of the IO, whichever is earlier. Invoices will be sent to Agency's billing address as set forth on the IO and will include information reasonably specified by Agency, such as the IO number, Advertiser name, brand name or campaign name, and any number or other identifiable reference stated as required for invoicing on the IO. All invoices (other than corrections of previously provided invoices) pursuant to the IO will be sent within 90 days of delivery of all Deliverables. Graphic Studio Central Ltd acknowledges that failure by Graphic Studio Central Ltd to send an initial invoice within such period may cause Agency to be contractually unable to collect payment from the Advertiser. If Graphic Studio Central Ltd sends the initial invoice after the 90-day period and the Agency either has not received the applicable funds from the Advertiser or does not have the Advertiser's consent to dispense such funds, Agency will use commercially reasonable efforts to assist Graphic Studio Central Ltd in collecting payment from the Advertiser or obtaining Advertiser's consent to dispense funds. Any failure by Agency to invoice the Advertiser within this time frame shall not in any way limit Graphic Studio Central Ltd's ability to collect funds from the Advertiser.<p class="text-justify">
									<p class="text-justify">Upon request from the Agency, Graphic Studio Central Ltd should provide proof of performance for the invoiced period, which may include access to online or electronic reporting, as addressed in these Terms. </p>
									<p class="text-justify">Graphic Studio Central Ltd should invoice Agency for the services provided with the net cost (i.e., the cost after subtracting any applicable discounts and commissions, including but not limited to Agency commissions, if any) based on actual delivery, flat-fee, or based on prorated distribution of delivery over the term of the IO, as specified on the applicable IO. </p>
									<p class="text-justify">The Advertiser or Agency will be charged based on the number of impressions. We will use the COST PER THOUSAND (CPM) method to calculate the advertising cost.</p>

									<p class="text-justify"><b>Advertising cost  = Total number of impressions/ 1000 x CPM.</b></p>

									<p class="text-justify"><b>Payment Date.</b> Order acceptance is subject to credit approval of Advertiser and/or Agency; Advertiser shall provide information reasonably requested by Graphic Studio Central Ltd to evaluate such entity's credit and Graphic Studio Central Ltd reserves the right to cancel credit at any time for any reason in its sole discretion, with or without notice. Provided credit is approved, payment is due thirty (30) days from invoice date, unless otherwise agreed in writing by Graphic Studio Central Ltd. </p>
									<p class="text-justify"><b>Payment Liability.</b>Graphic Studio Central Ltd may hold Agency liable for payments due by Advertiser, as the disclosed agent of the Advertiser, in the event of non-payment by Advertiser for Ads placed in accordance with the terms of the IO. Agency agrees that Graphic Studio Central Ltd may hold Agency liable for payments in the event that proceeds have not cleared from Advertiser for Ads placed in accordance with the IO. Advertiser shall keep records related to payments made by it to Agency with respect to services provided by Graphic Studio Central Ltd under this Agreement and Agency shall keep records related to payments received by it from Advertiser with respect to services provided by Graphic Studio Central Ltd under this Agreement, and upon reasonable notice from Graphic Studio Central Ltd, Advertiser and Agency shall allow Graphic Studio Central Ltd to review such records. Unless otherwise set forth by the Graphic Studio Central Ltd in the IO, a 2% per month (pro-rated for part thereof) penal interest on late payments shall be levied from the date of receipt of an invoice by the Graphic Studio Central Ltd.</p>
									<p class="text-justify">Agency agrees to make every reasonable effort to collect and clear payment from Advertiser on a timely basis.</p>
									<p class="text-justify">Agency's credit is established on a client-by-client basis.</p>
									<p class="text-justify">If Advertiser proceeds have not cleared for the IO, other advertisers from Agency will not be prohibited from advertising on the Site due to such non-clearance if such other advertisers' credit is not in question.</p>
									<p class="text-justify">Upon request, Agency will make available to Graphic Studio Central Ltd written confirmation of the relationship between Agency and Advertiser. This confirmation should include, for example, Advertiser's acknowledgement that Agency is its agent and is authorized to act on its behalf in connection with the IO and these Terms. In addition, upon the request of Graphic Studio Central Ltd, Agency will confirm whether Advertiser has paid to Agency in advance funds sufficient to make payments pursuant to the IO.</p>
									<p class="text-justify">If Advertiser's or Agency's credit is or becomes impaired, Graphic Studio Central Ltd may require payment in advance.</p>
									<p class="text-justify">Payment Recovery Costs. Pursuant to Section III(b) above, in the event that Graphic Studio Central Ltd is required to seek payment directly from Advertiser, Graphic Studio Central Ltd may impose additional costs on Advertiser in relation to the IO associated with the recovery of the outstanding payment (i.e., the reasonable costs of debt recovery companies instructed to recover the payments).</p>

									<h2>Reporting</h2>
									<p class="text-justify"><b>Graphic Studio Central Ltd Reporting.</b> If Graphic Studio Central Ltd is serving the campaign, Graphic Studio Central Ltd may make reporting available at least as often as weekly, either electronically or in writing, unless otherwise specified on the IO. Reports will be broken out by day and summarized by creative execution, content area (Ad placement), impressions, clicks, spend/cost, and other variables as may be defined on the IO (e.g., keywords).</p>
									<p class="text-justify">Once Graphic Studio Central Ltd has provided the online or electronic report, if applicable, it agrees that Agency and Advertiser are entitled to reasonably rely on it, subject to provision of Graphic Studio Central Ltd's invoice for such period.</p>

									<h2>Representations, Warranties and Covenants of Advertiser </h2>
									<p class="text-justify">Advertiser represents, warrants, and covenants to Graphic Studio Central Ltd as follows:</p>
									<p class="text-justify">Advertiser is authorized to act on behalf of and has bound to this Agreement any Principal for which Advertiser places an Ad, as between Principal and Advertiser, Principal owns any rights to information included in, and associated with, the content of such Ads, and Advertiser shall not use such information or content for any other purpose without Principal’s consent.</p>
									<p class="text-justify">Any redemption, discount, coupon or other promotional deadline shall be clearly and conspicuously disclosed in any Ad and any voucher, certificate, coupon or other document relating to such Ad.</p>
									<p class="text-justify">Advertiser shall not offer any promotions that may result in the enrollment of consumers in automatic renewal or membership programs or impose upon consumers any type of continuing obligation.</p>
									<p class="text-justify">Advertiser shall comply with all applicable federal and state laws and regulations governing advertising, marketing and promotions, including, without limitation, redemption, refund, cash-out obligations, and other inducement programs.</p>

									<h2>Content Submitted or Made Available For Inclusion on the Service</h2>
									<p class="text-justify">Please read this section carefully before you post, upload, or otherwise submit any Content to the Site. By posting any content to the site you explicitly grant www.tefltv.com a worldwide, non-exclusive license to use the content.  You warrant and represent to www.tefltv.com that the content you post is owned or duly licensed by you, and that www.tefltv.com is free to publish, distribute and use the content without the need to obtain the license or consent of any other person or entity.</p>
									<p class="text-justify">The Advertiser represents and warrants that it is fully authorized to publish the entire contents and subject matter contained in its advertisement(s) including the names, portraits and pictures of any persons living or dead, any copyrighted material, trademarks and depictions of trademarked goods and services and any testimonials or endorsements contained in any information or art submitted to and published by the Publisher. The Advertiser also represents and warrants that the entire content of each advertisement is accurate and complete and is not misleading.</p>
									<h2>Our liability as host</h2>
									<p class="text-justify">We are under no legal obligation to monitor content transmitted via or stored on the Website. Our only obligations as host concern (i) the fight against certain content in accordance with the procedure described in the Prohibited Content section, (ii) the retention of your connection data, which is moreover subject to an obligation of confidentiality and treated in compliance with the laws and regulations relating to Personal data and (iii) the removal of all clearly illegal content which has been effectively brought to our attention.</p>

									<h2>Termination</h2>
									<p class="text-justify">Advertisers can terminate their accounts at any time in their sole discretion. www.tefltv.com may also terminate accounts at any time in its sole discretion. All Videos that still remain on your account will be removed when your account is terminated.</p>

									<h2>Copyright Complaints</h2>
									<p class="text-justify">www.tefltv.com will respond promptly to any claim that Content posted on the Site infringes upon the copyrights or other intellectual property of any person or entity. www.tefltv.com will use reasonable efforts to investigate reports of alleged copyright infringement and will take appropriate action under intellectual property law and these Terms when it believes an image violates copyright law.  Appropriate actions shall include, but are not limited to, preventing access to the Content claimed to constitute copyright infringement, and disabling or deleting accounts that post content that constitutes copyright infringement.</p>
									<p class="text-justify">You must submit a written statement to the attention of “Copyright Infringement” care  in order to notify www.tefltv.com of any alleged infringement on your copyright rights. The statement must include a detailed description of the alleged copyright infringement that provides sufficient detail to enable www.tefltv.com to make a reasonable determination that the material constitutes copyright infringement. Anyone making a false claim of copyright infringement will be held accountable for damages, including costs and attorneys’ Proceeds, for misrepresenting that any images constitute copyright infringement.</p>
									<p class="text-justify">www.tefltv.com will make reasonable attempts to contact the person who posted the affected Content if www.tefltv.com removes or disables access to content in response to a written infringement statement.  You may provide www.tefltv.com with a counter notice in writing to the attention of “Copyright Infringement Counter Notification” if you believe that your content does not constitute copyright infringement.  In your counter notice, you must provide sufficient information to enable www.tefltv.com to make a reasonable determination as to whether the content constitutes copyright infringement. Please note that you may be held accountable for damages (including costs and attorneys' Proceeds) if you materially misrepresent that your Content does not infringe the copyrights of others.</p>
									<p class="text-justify">You should contact an attorney for advice if you are uncertain whether an activity constitutes copyright infringement.</p>

									<h2>Cancellation</h2>
									<p class="text-justify">Advertiser may cancel or terminate advertising online through Advertiser’s account if online cancellation functionality is available, or, if not available, with advance written notice to www.tefltv.com, including, without limitation, electronic mail. Online auction-based advertising cancelled online or through other means will cease as soon as commercially reasonable after cancellation, determined by considering functionality, technological limitations, www.tefltv.com commitments, and www.tefltv.com’ ability to re-schedule reserved inventory or cancel Ads already in production. If an Ad is displayed despite www.tefltv.com’ commercially reasonable efforts to cancel the Ad, Advertiser shall remain obligated to pay for such Ads. Cancelled Ads may be displayed on the www.tefltv.com Network despite cancellation if cancellation of those Ads occurs after any applicable commitment date as set forth in advance by www.tefltv.com. www.tefltv.com may cancel immediately any Ad program or this Agreement, at any time and without any reason, by providing Advertiser notice by electronic mail or other reasonable means of communication. </p>

									<h2>Release and Indemnity</h2>
									<p class="text-justify">Through your use of the www.tefltv.com site you expressly and irrevocably release and forever discharge www.tefltv.com, its affiliated and associated companies, and their respective directors, officers, employees, agents, representatives, contractors, licensees, successors and assigns from any and all actions, causes of action, suits, proceedings, liability, debts, judgments, claims and demands whatsoever in law or equity which you have ever had, now have, or hereafter can, shall or may have, for or by reason of, or arising directly or indirectly out of your use of www.tefltv.com and its Services or nature of any advertisement(s) supplied by the Advertiser.</p>
									<p class="text-justify">You hereby agree to indemnify and hold harmless www.tefltv.com, its affiliated and associated companies, and their respective directors, officers, employees, agents, representatives, contractors, licensees, successors and assigns from and against all claims, losses, expenses, damages and costs (including, but not limited to, direct, incidental, consequential, exemplary and indirect damages), and reasonable attorneys' Proceeds, resulting from or arising out of (i) a breach of these Terms, (ii) Content posted on the Site arising from Advertiser’s placement of Ads on the www.tefltv.com, including, without limitation, Losses stemming (iii) from libel, defamation, plagiarism, invasion of privacy, and infringement or unauthorized content claims, (iv) the unauthorized use of any person’s name, photograph or likeness, or (v) Advertiser’s coupons, discount offers, redemptions, or other promotional items or programs of any kind.</p>

									<h2>Limitation of Liability</h2>
									<p class="text-justify">In no event shall www.tefltv.com be liable under contract, tort, strict liability, negligence or any other legal theory with respect to the site, the Services or any content (i) for any lost profits or special, indirect, incidental, punitive, or consequential damages of any kind whatsoever, (ii) to provide substitute goods or services; or (iii) for any direct damages.</p>

									<h2>Confidentiality</h2>
									<p class="text-justify">www.tefltv.com and Advertiser have disclosed or may disclose to each other information relating to the other party’s business (including, without limitation, data and other information pertaining to the Sites, affiliates and vendors that are or have been part of the www.tefltv.com Network), all of which to the extent previously, presently or subsequently disclosed to each other is “Proprietary Information”. Proprietary information does not include information that each party can document (a) is or becomes (through no improper action or inaction of a party or its representatives (as defined below)) generally known by the public, (b) was in its possession or known by it without restriction prior to receipt from the other party, or (c) becomes available to a party from a source other than the other party or its Representatives having no obligation of confidentiality. “Representatives,” when used with respect to either party, means that party’s affiliates, agents, managers, officers, directors, consultants and employees. The parties agree (i) to hold Proprietary Information in strict confidence and to take all reasonable precautions to protect such Proprietary Information (including, without limitation, all precautions each party employs with respect to its most confidential materials), (ii) not to make any use whatsoever at any time of such Proprietary Information, except for the purpose of evaluating the results of the Ads, (iii) not to copy any Proprietary Information for any purpose whatsoever without the prior written consent of the disclosing party, and (iv) not to divulge any Proprietary information or any information derived there from to any third party or employee, except those of each party’s employees who have a legitimate “need to know” and are bound in writing to the restrictions herein.</p>
									<p class="text-justify">Each party will be responsible for a breach of this Agreement by any of its Representatives. </p>
									<p class="text-justify">Each party shall promptly notify the other party upon discovery of any unauthorized use or disclosure of Proprietary Information and will cooperate with the other party in every reasonable way to help regain possession of such Proprietary Information and prevent its future unauthorized use.</p>

									<h2>Marketing; Press Releases</h2>
									<p class="text-justify">Advertiser shall not release any information regarding its or any Publisher’s relationship with www.tefltv.com or its customers, including, without limitation, in press releases or promotional or merchandising materials, without the prior written consent of www.tefltv.com.  www.tefltv.com shall have the right to reference its work for, and relationships with, Advertisers for marketing and promotional purposes.  No press releases or general public commencements shall be made without the mutual consent of www.tefltv.com and Advertiser.</p>

									<h2>Assignment</h2>
									<p class="text-justify"> No rights or obligations under this Agreement may be assigned by Advertiser without the prior written consent of www.tefltv.com. Any assignment, transfer or attempted assignment or transfer in violation of this Section shall be void and of no force and effect. www.tefltv.com and any of its subsequent assignees may assign this Agreement, in whole or in part, or any of its rights or delegate any of its duties, under this Agreement to any party. This Agreement shall be binding upon and inure to the benefit of the parties and their respective permitted successors and assigns.</p>

									<h2>Independent Contractors</h2>
									<p class="text-justify">Each party is an independent contractor. Any intention to create a joint venture or partnership between the parties is expressly disclaimed. Except as set forth herein, neither party is authorized or empowered to obligate the other or to incur any costs on behalf of the other without the other party’s prior written consent.</p>

									<h2>Termination</h2>
									<p class="text-justify">Advertisers who wish to terminate their www.tefltv.com accounts may simply stop using the Services or may delete their accounts.  www.tefltv.com reserves the right to terminate any and all Services and/or your www.tefltv.com account immediately, without prior notice or liability, for any reason whatsoever, including, its determination, in its sole discretion, that you have breached any of the Terms. Upon termination of your account, your right to use the Services will immediately cease.</p>
									<p class="text-justify">All Terms that may survive termination shall survive termination, including, without limitation, ownership provisions, warranty disclaimers, indemnity and limitations of liability.</p>
									<p class="text-justify">It is your responsibility to back up all Content from your account prior to termination. When your www.tefltv.com account is terminated, we will automatically remove all Content posted to your account.</p>

									<h2>Change</h2>
									<p class="text-justify">www.tefltv.com reserves the right, at its sole discretion, to eliminate, modify or replace any of the Terms at any time. If an alteration constitutes a material change to the Terms, www.tefltv.com will notify Advertisers by posting an announcement on the site.  www.tefltv.com will determine what constitutes a material change in its sole discretion. Advertisers are solely responsible for reviewing and becoming familiar with any modifications to the Terms. Using any service or viewing any content following notification of a material change to the Terms shall constitute your acceptance of the revised Terms.</p>
									<h2>Miscellaneous</h2>
									<p class="text-justify">No agency, partnership, joint venture, or employment is established between you and www.tefltv.com under these Terms.  Advertisers are not granted any rights against www.tefltv.com through the terms of this agreement. www.tefltv.com ’s failure to pursue any breach of the Terms shall not be deemed a waiver of any further rights hereunder. www.tefltv.com shall not be liable for any failure to perform its obligations where such failure results from any cause beyond www.tefltv.com ’s reasonable control, including, without limitation, mechanical, electronic or communications failure or degradation.  If any provision of the Terms is found to be unenforceable or invalid, that provision shall be stricken.  The remainder of the Terms shall remain in full force and effect. www.tefltv.com may transfer, assign or delegate the Terms and www.tefltv.com ’s rights and obligations without your prior consent. The Terms shall be governed by and construed in accordance with the laws of Hong Kong and the parties shall be subject to the jurisdiction of Hong Kong Courts.  The Terms constitute the complete and exclusive statement of the mutual understanding of the parties.  The Terms supersede and cancel all previous written and oral agreements, communications and other understandings relating to the Terms’ subject matter.</p>
									<hr/>
									<br/><br/>
									<a href="#pub-H"><i class="fa fa-arrow-up"></i> Back to top.</a>
									<br/><br/>
